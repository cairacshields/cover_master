...
declare const GetUpscaleUltraTransactionId: {
    readonly metadata: {
...
declare const PostBackgroundTexture: {
    readonly body: {
        readonly type: "object";
        readonly properties: {
            readonly image: {
...
declare const PostEffectsPreviews: {
    readonly body: {
        readonly type: "object";
        ...
        readonly properties: {
            ...
            readonly effect_names: {
                readonly description: "Select up to 10 effects to preview by holding down the Ctrl key. The list of effects are as follows:\n  * apr1\n  * apr1\n  * apr2\n  * apr3\n  * brnz1\n  * brnz2\n  * brnz3\n  * brnz4\n  * cyber1\n  * cyber2\n  * dodger\n  * food1\n  * food2\n  * icy1\n  * icy2\n  * icy3\n  * mnch1\n  * mnch2\n  * mnch3\n  * spc1\n  * noise\n  * nature1\n  * nature2\n  * ntrl1\n  * ntrl2\n  * pixelize\n  * popart\n  * saturation\n  * sft1\n  * sft2\n  * sft3\n  * sft4\n  * shadow1\n  * shadow2\n  * sketcher1\n  * sketcher2\n  * tl1\n  * tl2\n  * urban1\n  * urban2\n  * water1\n  * water2\n  * brl1\n  * 1972\n";
                readonly type: "array";
                readonly minItems: 1;
                readonly items: {
                    readonly type: "string";
...
declare const PostMasksPreviews: {
    readonly body: {
        readonly type: "object";
        readonly required: readonly ["mask"];
        readonly properties: {
...
declare const PostStyletransfer: {
    readonly body: {
        readonly type: "object";
        readonly properties: {
            readonly image: {
...
declare const PostUpscaleEnhance: {
    readonly body: {
        readonly type: "object";
        readonly properties: {
            readonly image: {
...
declare const PostUpscaleUltra: {
    readonly body: {
        readonly type: "object";
        readonly properties: {
            readonly image: {
...
export { GetBalance, GetEffects, GetUpscaleUltraTransactionId, PostAdjust, PostBackgroundTexture, PostEdit, PostEffects, PostEffectsPreviews, PostEnhanceFace, PostMasks, PostMasksPreviews, PostRemovebg, PostStyletransfer, PostSurfacemap, PostUpload, PostUpscale, PostUpscaleEnhance, PostUpscaleUltra, PostVectorizer };
